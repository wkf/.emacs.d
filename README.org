...
- [ ] add better lispy open, bind to C-RET?
- [ ] reconsider electric spaces for lispy/lispville
- [ ] quick way to flip between buffers
- [ ] add ace/split actions to more ivy commands
- [ ] make E motion land on the end of symbol, not after
