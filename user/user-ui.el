...
(custom-set-faces
 ...
 ;; `(avy-lead-face ((t (:inherit isearch))))
 ;; `(avy-lead-face-0 ((t (:inherit isearch))))
 ;; `(avy-lead-face-1 ((t (:inherit isearch))))
 ;; `(avy-lead-face-2 ((t (:inherit isearch))))
 ;; `(avy-background-face ((t (:inherit isearch))))
...
;; (print base16-material-darker-colors)
;; (print base16-material-darker)
(provide 'user-ui)
