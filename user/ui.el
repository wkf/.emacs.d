...
(custom-set-faces
 ...
 `(fringe ((t (:background ,user/black :underline nil))))
 ...
 `(avy-lead-face-1 ((t (:background ,user/bright-black :foreground ,user/black))))
 `(avy-lead-face-2 ((t (:background ,user/purple :foreground ,user/black))))
 `(avy-lead-face ((t (:background ,user/red :foreground ,user/black))))
